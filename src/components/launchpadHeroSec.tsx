...
interface LaunchpadHeroSecProps {
    title: string;
    head: string;
    info: string[];
    img: string;
...
const LaunchpadHeroSec = ({ title, head, info, img, bline }: LaunchpadHeroSecProps) => {
    return (
            ...
            <div className="max-w-[1348px] flex gap-16 justify-between items-end z-2">
                <div className="max-w-[790px] rounded-md space-y-8 pr-20">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="">
                        <p>No long contracts. Transparent pricing starting at just $15/hour.</p>
                        <p>Try us completely risk-free - 15 days free trial with no obligation.</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="font-semibold italic text-[#FBBC05]">{bline}</p>
                    </div>
                </div>
...
export default LaunchpadHeroSec